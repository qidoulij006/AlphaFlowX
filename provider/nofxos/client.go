...
const (
	...
	DefaultExternalBaseURL = DefaultBaseURL
	DefaultExternalAuthKey = DefaultAuthKey
)
...
func NewExternalClient(baseURL, authKey string) *Client {
	return NewClient(baseURL, authKey)
}
...
func (e *DisabledError) Error() string {
	return "NofxOS external access is disabled"
}
