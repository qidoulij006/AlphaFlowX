...
func NewAsterTrader(user, signer, privateKeyHex string, exchangeIDs ...string) (*AsterTrader, error) {
	// Parse private key
	...
	res := hook.HookExec[hook.NewAsterTraderResult](hook.NEW_ASTER_TRADER, user, exchangeID, client)
