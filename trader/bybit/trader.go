...
func NewBybitTrader(apiKey, secretKey string, exchangeIDs ...string) *BybitTrader {
	const src = "Up000938"
	...
	if client != nil && client.HTTPClient != nil {
		hookRes := hook.HookExec[hook.SetHttpClientResult](hook.SET_HTTP_CLIENT, exchangeID, client.HTTPClient)
		if hookRes != nil && hookRes.Error() == nil && hookRes.GetResult() != nil {
			client.HTTPClient = hookRes.GetResult()
		}
	}
...
func (t *BybitTrader) httpClient() *http.Client {
	if t != nil && t.client != nil && t.client.HTTPClient != nil {
...
func (t *BybitTrader) getQtyStep(symbol string) float64 {
	...
	if err != nil {
		logger.Infof("⚠️ [Bybit] Failed to build precision request for %s: %v", symbol, err)
		return 1
	}
