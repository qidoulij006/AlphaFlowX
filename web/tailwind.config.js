    ...
    extend: {
      colors: {
        'nofx-gold': {
          ...
          dim: 'rgb(var(--c-gold) / 0.1)',
          glow: 'rgb(var(--c-gold) / 0.5)',
          highlight: 'rgb(var(--c-gold-highlight) / <alpha-value>)',
        },
        'nofx-bg': {
          DEFAULT: 'rgb(var(--c-bg) / <alpha-value>)',
          deeper: 'rgb(var(--c-bg-deeper) / <alpha-value>)',
          lighter: 'rgb(var(--c-bg-lighter) / <alpha-value>)',
        },
        'nofx-accent': 'rgb(var(--c-accent) / <alpha-value>)',
        'nofx-text': {
          DEFAULT: 'rgb(var(--c-text) / <alpha-value>)',
          main: 'rgb(var(--c-text) / <alpha-value>)',
          muted: 'rgb(var(--c-text-muted) / <alpha-value>)',
        },
        'nofx-success': 'rgb(var(--c-success) / <alpha-value>)',
        'nofx-danger': 'rgb(var(--c-danger) / <alpha-value>)',
      },
      fontFamily: {
