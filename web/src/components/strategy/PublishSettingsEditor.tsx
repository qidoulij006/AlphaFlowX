      ...
      <div
        ...
        style={{
          background: isPublic
            ...
            : 'linear-gradient(135deg, var(--panel-bg-solid) 0%, var(--panel-bg) 100%)',
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: isPublic ? 'rgba(14, 203, 129, 0.2)' : 'var(--panel-bg)',
          ...
          <div className="flex items-center gap-3">
            <span
              ...
              style={{ color: isPublic ? '#0ECB81' : 'var(--text-secondary)' }}
            >
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className="p-2.5 rounded-lg transition-all duration-300"
                style={{
                  background: configVisible ? 'rgba(168, 85, 247, 0.2)' : 'var(--panel-bg)',
