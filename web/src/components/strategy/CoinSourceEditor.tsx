...
export function CoinSourceEditor({
  ...
  const sourceTypes = [
    { value: 'static', icon: List, color: 'var(--text-secondary)' },
  ...
  // External data badge component
  const ExternalDataBadge = () => (
    <span
      className="text-[9px] px-1.5 py-0.5 rounded font-medium bg-red-500/12 text-red-400 border border-red-500/20"
    >
