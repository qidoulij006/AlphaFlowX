...
export default function HowItWorksSection({ language }: HowItWorksSectionProps) {
  const steps = [
    {
      ...
      code: 'curl -fsSL https://alphaflowx.com/install.sh | bash',
    },
    {
      icon: Rocket,
      number: '02',
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-nofx-bg-deeper">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-nofx-text-main">
                ...
                >
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-xl font-bold text-nofx-text-main">
                        {step.title}
                      </h3>
                    </div>
                    <p className="mb-4 text-nofx-text-muted">
                      {step.desc}
                    </p>
                    ...
                    <div
                      ...
                      style={{
                        background: 'color-mix(in srgb, var(--panel-bg-solid) 72%, transparent)',
                        border: '1px solid var(--glass-border)',
                      }}
                    >
