...
export default function AboutSection({ language }: AboutSectionProps) {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-nofx-bg">
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-nofx-text-main">
              {t('whatIsNofx', language)}
            </h2>

            <p className="text-lg mb-8 leading-relaxed text-nofx-text-muted">
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-xs ml-2 text-[var(--text-tertiary)]">terminal</span>
              </div>

              {/* Terminal Content */}
              <div className="p-6 font-mono text-sm space-y-2">
                <div style={{ color: 'var(--text-tertiary)' }}>$ curl -fsSL https://alphaflowx.com/install.sh | bash</div>
                <div style={{ color: 'var(--text-tertiary)' }}>$ cd ~/alphaflowx && docker compose ps</div>
                <div style={{ color: 'var(--text-tertiary)' }}>$ cd ~/alphaflowx && docker compose up -d</div>
