                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12 md:text-left">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="relative overflow-hidden group bg-[var(--panel-bg)] backdrop-blur-md border border-[var(--glass-border)] p-6 rounded-lg md:bg-transparent md:border-0 md:p-0 md:backdrop-blur-none"
                        >
                            {/* Mobile Neon Corners */}
                            ...
                            <div className="text-3xl md:text-6xl font-black text-nofx-text-main tracking-tighter mb-2 group-hover:scale-110 transition-transform duration-300 origin-left relative z-10">
                                {stat.value}
                            </div>
                            <div className="text-[10px] md:text-base font-bold text-nofx-text-muted md:text-black/60 uppercase tracking-widest bg-white/5 md:bg-white/20 inline-block px-2 py-1 rounded relative z-10">
                                {stat.label}
                            </div>
                        </motion.div>
                    ))}
