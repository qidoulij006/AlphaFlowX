...
export default function AgentTerminal() {
    return (
        ...
        >
            {/* Terminal frame */}
            <div className="relative bg-[var(--panel-bg-solid)] rounded-2xl overflow-hidden shadow-2xl shadow-black/40 border border-[var(--glass-border)]">
                ...
                <div className="flex items-center justify-between px-4 py-2.5 bg-[var(--panel-bg)] border-b border-[var(--glass-border)]">
                    {/* Window controls */}
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
                        <span className="text-nofx-text-muted text-xs font-mono">{BRAND_INFO.shortName} Agent Terminal</span>
                    </div>
                    {/* Live indicator */}
                ...
                <div className="p-4 border-b border-[var(--glass-border)]">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex gap-1">
                            ...
                            <button className="px-2 py-0.5 text-[10px] text-[var(--text-tertiary)] font-mono hover:text-nofx-text-muted transition-colors">7D</button>
                            <button className="px-2 py-0.5 text-[10px] text-[var(--text-tertiary)] font-mono hover:text-nofx-text-muted transition-colors">30D</button>
                        </div>
                    </div>
                ...
                {/* Metrics Row */}
                <div className="grid grid-cols-3 divide-x divide-[var(--glass-border)] border-b border-[var(--glass-border)]">
                    <div className="p-3 text-center">
                        <div className="text-nofx-text-muted text-[10px] font-mono uppercase tracking-wider mb-1">OI</div>
                        <div className="text-nofx-text-main font-bold font-mono">$847M</div>
                    ...
                    <div className="p-3 text-center">
                        ...
                        <div className="text-nofx-text-main font-bold font-mono">1.24</div>
                ...
                <div className="p-4 border-b border-[var(--glass-border)]">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-nofx-text-muted text-xs font-mono uppercase tracking-wider">Order Book</span>
                        <span className="text-[var(--text-tertiary)] text-[10px] font-mono">Spread: <span className="text-nofx-gold">0.02%</span></span>
                    </div>
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-nofx-text-muted text-xs font-mono uppercase tracking-wider">Positions</span>
                    ...
                    <div className="space-y-2">
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between py-2 px-2 rounded-lg bg-[var(--panel-bg)] hover:bg-[var(--panel-bg-hover)] transition-colors">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-nofx-text-main text-sm font-mono">{pos.name}</div>
                ...
                {/* Footer status bar */}
                <div className="px-4 py-2 bg-[var(--panel-bg)] border-t border-[var(--glass-border)] flex items-center justify-between">
