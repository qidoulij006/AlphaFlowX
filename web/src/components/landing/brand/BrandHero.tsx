    ...
    return (
        <section className="relative w-full min-h-screen bg-nofx-bg text-nofx-text overflow-hidden flex flex-col pt-16">
            ...
            <div className="w-full bg-nofx-gold text-black font-bold py-2 border-y border-black z-20">
                <Marquee speed={40}>
                    <span className="mx-8 text-sm md:text-base uppercase tracking-widest">{BRAND_INFO.name} AI TRADING • AUTOMATED WEALTH • DECENTRALIZED INTELLIGENCE • PUNK ETHOS •</span>
                    <span className="mx-8 text-sm md:text-base uppercase tracking-widest">{BRAND_INFO.name} AI TRADING • AUTOMATED WEALTH • DECENTRALIZED INTELLIGENCE • PUNK ETHOS •</span>
                </Marquee>
            </div>
                ...
                <div className="flex-1 flex flex-col justify-center px-6 lg:px-16 pt-12 lg:pt-0 relative z-20">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-nofx-text-muted max-w-xl mb-10 font-mono leading-relaxed">
                            ...
                            <span className="text-nofx-text-main font-bold ml-2 bg-nofx-accent px-2 py-0.5">DEGENERATES</span>.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="border-2 border-[var(--glass-border)] text-nofx-text-main text-lg font-bold px-8 py-4 uppercase tracking-wider hover:bg-white/10 hover:border-nofx-text-main transition-all flex items-center gap-2"
                            >
                                <Github className="w-5 h-5" /> Source
                            </a>
                        </div>

                        <div className="mt-12 flex items-center gap-8 text-[var(--text-tertiary)] font-mono text-xs md:text-sm">
