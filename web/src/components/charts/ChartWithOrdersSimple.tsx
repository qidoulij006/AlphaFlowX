...
export function ChartWithOrdersSimple({
  ...
  return (
    <div className="relative" style={{ background: 'var(--panel-bg-solid)', borderRadius: '8px', overflow: 'hidden', minHeight: height, border: '1px solid var(--panel-border)' }}>
      {/* 标题栏 */}
      <div className="flex items-center justify-between p-4" style={{ borderBottom: '1px solid var(--panel-border)' }}>
      ...
      <div className="p-8 space-y-4">
        {error ? (
          ...
          <>
            <div className="p-4 rounded" style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)' }}>
              <div className="text-sm mb-2" style={{ color: 'var(--text-secondary)' }}>币安K线数据</div>
            ...
            {traderID && (
              <div className="p-4 rounded" style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)' }}>
                <div className="text-sm mb-2" style={{ color: 'var(--text-secondary)' }}>历史订单数据</div>
            ...
            <div className="p-4 rounded" style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)' }}>
              <div className="text-sm mb-2" style={{ color: 'var(--text-secondary)' }}>状态</div>
