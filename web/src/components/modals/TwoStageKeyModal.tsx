  ...
  const modalContent = useMemo(() => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
        <div
          className="p-8 rounded-xl max-w-lg w-full mx-4"
          style={{
        ...
        >
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>
              ...
              {contextLabel && (
                <span className="text-base font-normal ml-2" style={{ color: 'var(--text-secondary)' }}>
                  ({contextLabel})
                </span>
              )}
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 text-white font-medium py-3 px-4 rounded-lg transition-colors"
                  style={{
                    background:
                      (part1.startsWith('0x') ? part1.slice(2) : part1).length <
                        expectedPart1Length || processing
            ...
            >
              ...
              {clipboardStatus === 'failed' && manualObfuscationValue && (
                <div style={{ color: '#B45309' }}>
                  ...
                  <div
                    className="text-xs mt-2 p-2 rounded font-mono break-all border"
                    style={{
                      background: 'var(--panel-bg)',
