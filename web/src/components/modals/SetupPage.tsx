      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-bold text-nofx-text-main mb-1.5">Welcome to {BRAND_INFO.name}</h1>
            <p className="text-nofx-text-muted text-sm">Create your account to get started</p>
          </div>
          ...
          <div className="theme-surface rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Email */}
              <div>
                <label className="block text-xs font-medium text-nofx-text-muted mb-2">Email</label>
                <input
                  type="email"
                  value={email}
              ...
              {/* Password */}
              <div>
                <label className="block text-xs font-medium text-nofx-text-muted mb-2">Password</label>
                <div className="relative">
                  <input
