...
export function WebCryptoEnvironmentCheck({
  ...
  const containerClass = isCompact
    ? 'p-3 rounded space-y-3'
    : 'p-4 rounded space-y-4'

  const descriptionColor = isCompact ? 'var(--text-primary)' : 'var(--text-secondary)'
  ...
  return (
    <div className={containerClass} style={{ border: '1px solid var(--panel-border)', background: isCompact ? 'var(--panel-bg-solid)' : 'var(--panel-bg)' }}>
