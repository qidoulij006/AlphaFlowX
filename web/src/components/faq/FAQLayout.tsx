  ...
  return (
    <DeepVoidBackground className="py-6 pt-24" disableAnimation>
      <div className="w-full px-4 md:px-8">
          ...
          <main className="flex-1 min-w-0">
            {filteredCategories.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-lg text-nofx-text-muted">
                  {language === 'zh'
                    ? '没有找到匹配的问题'
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2 rounded-lg font-semibold transition-all hover:opacity-90 bg-gradient-to-br from-nofx-gold to-[#FCD535] text-black"
                >
        ...
        {/* Contact Section */}
        <div className="mt-16 p-8 rounded-lg text-center border border-nofx-gold/20 bg-[linear-gradient(135deg,rgba(240,185,11,0.1)_0%,rgba(252,213,53,0.05)_100%)]">
          <h3 className="text-xl font-bold mb-3 text-nofx-text-main">
            {t('faqStillHaveQuestions', language)}
          </h3>
          <p className="mb-6 text-nofx-text-muted">
            {t('faqContactUs', language)}
          </p>
          <div className="flex items-center justify-center">
            <a
              href="https://t.me/+0kL0A0Zw4AIyMmNl"
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 bg-gradient-to-br from-nofx-gold to-[#FCD535] text-black"
            >
