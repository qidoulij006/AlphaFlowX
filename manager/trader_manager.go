...
func (tm *TraderManager) addTraderFromStore(traderCfg *store.Trader, aiModelCfg *store.AIModel, exchangeCfg *store.Exchange, st *store.Store) error {
	...
	traderConfig := trader.AutoTraderConfig{
		...
		ReviewEnabled:            traderCfg.ReviewEnabled,
		ReviewWindow:             time.Duration(traderCfg.ReviewWindowMinutes) * time.Minute,
		ReviewTargetReturnPct:    traderCfg.ReviewTargetReturnPct,
		ReviewMaxLossProfitRatio: traderCfg.ReviewMaxLossProfitRatio,
