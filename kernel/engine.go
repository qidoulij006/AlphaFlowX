...
type StrategyEngine struct {
	...
	externalDataClient *nofxos.Client
}

// NewStrategyEngine creates strategy execution engine
func NewStrategyEngine(config *store.StrategyConfig) *StrategyEngine {
	// Create external quant data client with compatibility for legacy strategy JSON.
	apiKey := config.Indicators.GetExternalDataKey()
	if apiKey == "" {
		apiKey = nofxos.DefaultExternalAuthKey
	}
	client := nofxos.NewExternalClient(nofxos.DefaultExternalBaseURL, apiKey)
...
func (e *StrategyEngine) getAI500Coins(limit int) ([]CandidateCoin, error) {
	...
	symbols, err := e.externalDataClient.GetTopRatedCoins(limit)
	if err != nil {
		return nil, err
	}
...
func (e *StrategyEngine) getOITopCoins(limit int) ([]CandidateCoin, error) {
	...
	positions, err := e.externalDataClient.GetOITopPositions()
	if err != nil {
		return nil, err
	}
...
func (e *StrategyEngine) getOILowCoins(limit int) ([]CandidateCoin, error) {
	...
	positions, err := e.externalDataClient.GetOILowPositions()
	if err != nil {
		return nil, err
	}
...
func (e *StrategyEngine) FetchQuantData(symbol string) (*QuantData, error) {
	...
	nofxosData, err := e.externalDataClient.GetCoinData(symbol, include)
	if err != nil {
...
func (e *StrategyEngine) FetchOIRankingData() *nofxos.OIRankingData {
	...
	data, err := e.externalDataClient.GetOIRanking(duration, limit)
	if err != nil {
...
func (e *StrategyEngine) FetchNetFlowRankingData() *nofxos.NetFlowRankingData {
	...
	data, err := e.externalDataClient.GetNetFlowRanking(duration, limit)
	if err != nil {
...
func (e *StrategyEngine) FetchPriceRankingData() *nofxos.PriceRankingData {
	...
	data, err := e.externalDataClient.GetPriceRanking(durations, limit)
	if err != nil {
