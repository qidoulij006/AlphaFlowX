...
const (
	...
	NEW_BINANCE_TRADER = "NEW_BINANCE_TRADER" // func (userID string, exchangeID string, client *futures.Client) *NewBinanceTraderResult
	NEW_ASTER_TRADER   = "NEW_ASTER_TRADER"   // func (userID string, exchangeID string, client *http.Client) *NewAsterTraderResult
	SET_HTTP_CLIENT    = "SET_HTTP_CLIENT"    // func (exchangeID string, client *http.Client) *SetHttpClientResult
)
